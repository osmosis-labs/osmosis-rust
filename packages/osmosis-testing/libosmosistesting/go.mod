...
require (
	...
	github.com/osmosis-labs/osmosis/osmoutils v0.0.0-20230130075237-62557eac2673 // indirect
	github.com/osmosis-labs/osmosis/x/ibc-hooks v0.0.0-20230201094300-e8bba2b45fd8 // indirect
