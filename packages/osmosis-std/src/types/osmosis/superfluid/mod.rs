...
pub struct SuperfluidDelegationsByDelegatorResponse {
    ...
    >,
    #[prost(message, optional, tag = "3")]
    pub total_equivalent_staked_amount: ::core::option::Option<
        cosmos_sdk_proto::cosmos::base::v1beta1::Coin,
    >,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct SuperfluidUndelegationsByDelegatorResponse {
    ...
    >,
    #[prost(message, repeated, tag = "2")]
    pub total_undelegated_coins: ::prost::alloc::vec::Vec<
        cosmos_sdk_proto::cosmos::base::v1beta1::Coin,
    >,
...
pub struct GenesisState {
    ...
    #[prost(message, repeated, tag = "3")]
    pub osmo_equivalent_multipliers: ::prost::alloc::vec::Vec<
        OsmoEquivalentMultiplierRecord,
    >,
